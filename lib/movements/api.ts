 ...
 * 
 * Este módulo centraliza todas las operaciones relacionadas con movimientos:
 * - Operaciones CRUD (crear, leer)
 * - Gestión de estados (iniciar proceso, completar, revertir)
 * - Obtención de listas y detalles
 * - Filtrado y paginación
 * - Mapeo de tipos y etiquetas
 * - Formateo de fechas para el backend
 * 
 * @module movements-api
 */
