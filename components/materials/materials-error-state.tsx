/**
 * Componente MaterialsErrorState - Estado de error compartido para materiales
 * Muestra un mensaje de error con opción de reintentar
 * 
 * @example
 * ```tsx
 * if (error) {
 *   return <MaterialsErrorState error={error} onRetry={reload} />
 * }
 * ```
 */
...
export function MaterialsErrorState({ 
  error, 
  onRetry,
  variant = 'default'
}: MaterialsErrorStateProps) {
